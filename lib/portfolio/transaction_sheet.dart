...
class TransactionSheetState extends State<TransactionSheet> {
  ...
  _checkValidSymbol(String inputSymbol) async {
    if (symbolList.isEmpty) {
      symbolList = [];
      widget.marketListData.forEach(
        (value) => symbolList.add(value["CoinInfo"]["Name"]),
      );
    }
  ...
  _initEditMode() {
    ...
    pickedDate = new DateTime.fromMillisecondsSinceEpoch(
      widget.snapshot["time_epoch"],
    );
                ...
                children: <Widget>[
                  new Container(
                    ...
                    child: new TextField(
                      ...
                      style: Theme.of(
                        context,
                      ).textTheme.body2.apply(color: symbolTextColor),
                  ...
                  new Container(
                    ...
                    child: new TextField(
                      ...
                      style: Theme.of(
                        context,
                      ).textTheme.body2.apply(color: quantityTextColor),
                  ...
                  new Container(
                    ...
                    child: new TextField(
                      ...
                      style: Theme.of(
                        context,
                      ).textTheme.body2.apply(color: priceTextColor),
                      keyboardType: TextInputType.numberWithOptions(
                        decimal: true,
                      ),
                      decoration: new InputDecoration(
                ...
                children: <Widget>[
                  ...
                  new Container(
                    ...
                    child: new TextField(
                      ...
                      style: Theme.of(
                        context,
                      ).textTheme.body2.apply(color: validColor),
            ...
            children: <Widget>[
              ...
              new Container(
                child: new FloatingActionButton(
                  ...
                  elevation: quantity != null ? 4.0 : 0.0,
                  backgroundColor:
                      quantity != null
                          ? Colors.green
