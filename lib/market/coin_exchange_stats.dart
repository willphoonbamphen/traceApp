...
class CoinMarketStats extends StatefulWidget {
  CoinMarketStats({Key key, this.exchangeData, this.e}) : super(key: key);

  final exchangeData;
  final e;

  @override
  CoinMarketStatsState createState() =>
      new CoinMarketStatsState(exchangeData: exchangeData, e: e);
}

class CoinMarketStatsState extends State<CoinMarketStats> {
  CoinMarketStatsState({this.exchangeData, this.e});
                  ...
                  new Column(
                    ...
                    children: <Widget>[
                      ...
                      new Text(
                        "\$" +
                            numCommaParse(
                              exchangeData["VOLUME24HOURTO"].toStringAsFixed(0),
                            ),
