...
class CoinDetails extends StatefulWidget {
  CoinDetails({this.snapshot, this.enableTransactions = false});
...
class CoinDetailsState extends State<CoinDetails>
                                ...
                                children: <Widget>[
                                  ...
                                  new Row(
                                    children: <Widget>[
                                      ...
                                      new Text(
                                        ohlcvWidthOptions[historyTotal][currentOHLCVWidthSetting][0],
                                        style: Theme.of(context).textTheme.body2
                                            .apply(fontWeightDelta: 2),
                                      ),
                                    ],
  ...
  void _sortExchangeData() {
    ...
    if (sortType[1]) {
      sortedExchangeData.sort(
        (a, b) => b[sortType[0]].compareTo(a[sortType[0]]),
      );
    } else {
      sortedExchangeData.sort(
        (a, b) => a[sortType[0]].compareTo(b[sortType[0]]),
      );
    }
                  ...
                  new Column(
                    ...
                    children: <Widget>[
                      ...
                      new Text(
                        ...
                        style: Theme.of(
                          context,
                        ).textTheme.body2.apply(fontSizeFactor: 1.2),
                      ),
                    ],
                  ),
                  new Column(
                    ...
                    children: <Widget>[
                      ...
                      new PercentDollarChange(exact: net, percent: netPercent),
                    ],
                  ),
                  new Column(
                    crossAxisAlignment: CrossAxisAlignment.end,
                    children: <Widget>[
                      ...
                      new Text(
                        ...
                        style: Theme.of(
                          context,
                        ).primaryTextTheme.body2.apply(fontSizeFactor: 1.5),
                      ),
                    ],
                  ),
                ],
